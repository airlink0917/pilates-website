    ...
    getAvailableSlots: function(date, type) {
        ...
        baseSlots.forEach(slot => {
            ...
            if (type === 'trial') {
                ...
                const available = trialReservations.length === 0 ? 1 : 0;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generateTimeslots() {
        ...
        const slots = reservationStorage.getAvailableSlots(selectedDate, 'trial');
        ...
        slots.forEach(slot => {
            ...
            if (slot.available === 0) {
                ...
                slotElement.innerHTML = `
                    ${slot.time}
                    <div class="timeslot-status">予約済</div>
                `;
            } else {
                slotElement.innerHTML = `
                    ${slot.time}
                    <div class="timeslot-status">予約可</div>
                `;
    ...
    submitButton.addEventListener('click', function() {
        ...
        alert('体験レッスンの予約が完了しました。確認メールをお送りしています。');
